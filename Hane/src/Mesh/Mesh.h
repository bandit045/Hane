...
namespace Hane
{
	...
	public:
		...
		void addTriangleToMesh(Hane::Face& _faceTriangleToAdd);
		...
		Hane::Face& getTriangle(int _indexOfTriangleInsideMesh); // Trying to implement this function
	private:
		// This member variable store all triangles inside Mesh
		std::vector<Hane::Face> m_triangles;
