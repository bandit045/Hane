...
namespace Hane
{
    Face::Face(Hane::LiteralVertex& _vertexOne, Hane::LiteralVertex& _vertexTwo, Hane::LiteralVertex& _vertexThree)
    {
        std::cout << "Face constructor invoked! \n";
    ...
    Hane::LiteralVertex& Face::getVertex(int _indexOfVertex) // Trying to implement
    {
    ...
    {
        glm::vec3 edge1 = glm::vec3(m_vertices[1].getCordinate() - m_vertices[0].getCordinate());

        glm::vec3 edge2 = glm::vec3(m_vertices[2].getCordinate() - m_vertices[0].getCordinate());
